...
<div class="wrapper <?php if(isset($road_opt['page_layout']) && $road_opt['page_layout']=='box'){echo 'box-layout';}?>">
	<div class="page-wrapper">
	<?php
	if ( isset($road_opt['header_layout']) && $road_opt['header_layout']=='default' || !isset($road_opt['header_layout'])) {
		get_header('first');
	} else {
