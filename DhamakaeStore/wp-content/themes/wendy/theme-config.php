...
if (!class_exists('Road_Theme_Config')) {
    ...
    class Road_Theme_Config {
        ...
        public function setSections() {
            ...
            $this->sections[] = array(
                ...
                'fields'    => array(
					array(
                        ...
                        'subtitle'  => __('Pick a color for primary color (default: #00adef).', 'redux-framework'),
						'transparent' => false,
                        'default'   => '#00adef',
                        'validate'  => 'color',
                    ),
					...
					array(
                        ...
                        'subtitle'  => __('Pick a color for bg sale label (default: #e32916).', 'redux-framework'),
						'transparent' => false,
                        'default'   => '#e32916',
                        'validate'  => 'color',
                    ),
					...
					array(
                        ...
                        'subtitle'  => __('Pick a color for star of rating (default: #898989).', 'redux-framework'),
						'transparent' => false,
                        'default'   => '#898989',
                        'validate'  => 'color',
                    ),
			...
			$this->sections[] = array(
                ...
                'fields'    => array(
					...
					array(
                        ...
                        'options'   => array(
                            'default' => 'Default - Skin 1',
							'second' => 'Default - Skin 2',
							'third' => 'Second - Skin 1',
							'fourth' => 'Second - Skin 2',
                        ),
                        'default'   => 'default'
                    ),
					array(
                        ...
                        'type'      => 'text',
                        'title'     => __('Categories menu label', 'redux-framework'),
						'subtitle'     => __('The label for categories menu', 'redux-framework'),
                        'default'   => 'Category'
                    ),
					array(
						'id'        => 'categories_menu_items',
						'type'      => 'slider',
						'title'     => __('Number of items', 'redux-framework'),
						'desc'      => __('Number of menu items level 1 to show, default value: 8', 'redux-framework'),
						"default"   => 8,
						"min"       => 1,
						"step"      => 1,
						"max"       => 30,
					...
					array(
                        ...
                        'type'      => 'text',
                        'title'     => __('More Categories label', 'redux-framework'),
						'subtitle'     => __('The label for more categories button', 'redux-framework'),
                        'default'   => 'More Categories'
                    ),
					array(
                        'id'        => 'categories_less_label',
                        'type'      => 'text',
                        'title'     => __('Less Categories label', 'redux-framework'),
						'subtitle'     => __('The label for less categories button', 'redux-framework'),
                        'default'   => 'Close Menu'
                    ),
					array(
                        'id'        => 'categories_menu_home',
                        'type'      => 'switch',
                        'title'     => __('Home Categories Menu', 'redux-framework'),
						'subtitle'     => __('Always show categories menu on home page', 'redux-framework'),
						'default'   => true,
                    ),
					array(
                        'id'        => 'categories_menu_sub',
                        'type'      => 'switch',
                        'title'     => __('Inner Categories Menu', 'redux-framework'),
						'subtitle'     => __('Always show categories menu on inner pages', 'redux-framework'),
						'default'   => false,
                    ),
					array(
			...
			$this->sections[] = array(
				...
				'fields'     => array(
					array(
                        'id'        => 'follow_title',
                        'type'      => 'text',
                        'title'     => __('Follow Us title', 'redux-framework'),
                        'default'   => 'Follow Us'
                    ),
					array(
						'id'       => 'social_icons',
			...
			$this->sections[] = array(
				'icon'       => 'el-icon-website',
				'title'      => __( 'Business time', 'redux-framework' ),
				'subsection' => true,
				'fields'     => array(
					array(
                        'id'        => 'business_time_title',
                        'type'      => 'text',
                        'title'     => __('Business time title', 'redux-framework'),
			...
			$this->sections[] = array(
                ...
                'fields'    => array(
					...
					array(
						'id'       => 'sidebarcontact_pos',
						'type'     => 'radio',
						'title'    => __('Contact Sidebar Position', 'redux-framework'),
						'subtitle'      => __('Sidebar on Contact page', 'redux-framework'),
						'options'  => array(
							'left' => 'Left',
							'right' => 'Right'),
						'default'  => 'right'
